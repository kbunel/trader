...
export default class RoadTripStrategy extends Strategy {
  ...
  private isWorthyToSwitch(symbolToSwitchFor: BestCoin): boolean {
    ...
    if (!this.currentCrypto || this.currentCrypto.symbol != currentCryptoInWallet.symbol) {
    ...
    if (!this.symbolToSwitchFor || this.symbolToSwitchFor.symbol != symbolToSwitchFor.symbol) {
